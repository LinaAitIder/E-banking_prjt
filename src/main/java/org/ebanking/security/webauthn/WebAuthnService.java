...
public class WebAuthnService {
    ...
    public WebAuthnService(WebAuthnCredentialRepository credentialRepository, UserRepository userRepository) {
...
//                    .readValue(new String(client.getChallenge().getBytes(), StandardCharsets.UTF_8), CollectedClientData.class);
    ...
    public PublicKeyCredentialRequestOptions generateAuthenticationOptions(User user) {
        String credentialId = user.getWebAuthnCredentials().iterator().next().getCredentialId();
